...
(async () => {
  try {
    ...
    const url = `https://www.capterra.com/p/${company}/reviews/`;
    ...
    let reviews = await extractReviewsWithGemini(html, 'capterra', start, end, url);
    ...
    const filePath = path.join(outputDir, `${company}_capterra_top10.json`);
